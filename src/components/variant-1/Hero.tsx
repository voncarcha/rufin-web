          ...
          <div className="stagger-children">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <div className="flex">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} width="16" height="16" viewBox="0 0 24 24" fill="#E07B54" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col gap-4 lg:gap-6">
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-square shadow-lg destination-card">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <p className="text-[#E07B54] font-bold mt-1">From ₱45,000</p>
                </div>
              </div>
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3] destination-card group shadow-lg">
                ...
                <Link href="#packages" className="absolute bottom-4 right-4 w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center hover:bg-[#E07B54] transition-colors">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
