          ...
          {steps.map((step, index) => (
            <div key={step.number} className="relative">
              ...
              {index < steps.length - 1 && (
                <div className="hidden lg:block absolute top-8 left-[calc(50%+2rem)] w-[calc(100%-4rem)] h-0.5 bg-gradient-to-r from-[#E07B54]/30 to-[#1A5D5D]/30" />
              )}
              ...
              <div className="text-center">
                ...
                {/* Icon */}
                <div className="w-14 h-14 rounded-xl bg-[#FFF5EE] flex items-center justify-center mx-auto mb-4 text-[#E07B54]">
                  {step.icon}
                </div>
