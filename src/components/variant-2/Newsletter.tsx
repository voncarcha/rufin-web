          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#b58f32]/10 flex items-center justify-center flex-shrink-0">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" stroke="#b58f32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[#2D2D2D]">Phone / Viber</h3>
                  <a href="tel:+639277219365" className="text-[#6B7280] hover:text-[#b58f32] transition-colors">
                    +63 927 721 9365
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#b58f32]/10 flex items-center justify-center flex-shrink-0">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="#b58f32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M22 6L12 13L2 6" stroke="#b58f32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
                  <h3 className="font-semibold text-[#2D2D2D]">Email</h3>
                  <a href="mailto:rufintravelandtours@gmail.com" className="text-[#6B7280] hover:text-[#b58f32] transition-colors break-all">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#b58f32]/10 flex items-center justify-center flex-shrink-0">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 5.02944 7.02944 1 12 1C16.9706 1 21 5.02944 21 10Z" stroke="#b58f32" strokeWidth="2"/>
                    <circle cx="12" cy="10" r="3" stroke="#b58f32" strokeWidth="2"/>
                  </svg>
                </div>
                <div>
            ...
            <div className="mt-8 pt-8 border-t border-black/5">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#5D4E37]/10 flex items-center justify-center text-[#5D4E37] hover:bg-[#5D4E37] hover:text-white transition-all">
