      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <nav className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="tel:+639277219365" className="text-sm text-[#6B7280] hover:text-[#E07B54] transition-colors flex items-center gap-2">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-black/5">
            <div className="flex flex-col gap-4">
              <Link href="#packages" className="text-sm text-[#6B7280] hover:text-[#E07B54] font-medium" onClick={() => setMobileMenuOpen(false)}>
                Packages
              </Link>
              <Link href="#why-us" className="text-sm text-[#6B7280] hover:text-[#E07B54] font-medium" onClick={() => setMobileMenuOpen(false)}>
                Why Choose Us
              </Link>
              <Link href="#about" className="text-sm text-[#6B7280] hover:text-[#E07B54] font-medium" onClick={() => setMobileMenuOpen(false)}>
                About
              </Link>
              <Link href="#contact" className="text-sm text-[#6B7280] hover:text-[#E07B54] font-medium" onClick={() => setMobileMenuOpen(false)}>
                Contact
              </Link>
