        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[#E07B54] text-sm font-semibold">{packages[0].duration}</span>
            ...
            >
              ...
              {packages[1].tag && (
                <div className="absolute top-3 right-3">
                  <span className="text-[10px] text-white bg-[#1A5D5D] px-2 py-1 rounded-full uppercase tracking-wider">{packages[1].tag}</span>
                </div>
              )}
              <div className="absolute bottom-4 left-4 right-4">
                <span className="text-[#E07B54] text-xs font-semibold">{packages[1].duration}</span>
          ...
          <div className="package-card group">
            ...
            >
              ...
              {packages[2].tag && (
                <div className="absolute top-3 right-3">
                  <span className="text-[10px] text-white bg-[#1A5D5D] px-2 py-1 rounded-full uppercase tracking-wider">{packages[2].tag}</span>
                </div>
              )}
              <div className="absolute bottom-4 left-4 right-4">
                <span className="text-[#E07B54] text-xs font-semibold">{packages[2].duration}</span>
                <h3 className="font-[family-name:var(--font-playfair)] text-xl text-white font-medium">
                  {packages[2].name}
                </h3>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              {["Airfare", "Hotels", "Breakfast", "Transfers", "Tours"].map((item) => (
                <span key={item} className="flex items-center gap-2 text-sm text-[#1A5D5D] bg-[#1A5D5D]/10 px-3 py-1.5 rounded-full">
